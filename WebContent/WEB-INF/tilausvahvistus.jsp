			...
			<div class="row">
				<div class="tilaus">
					...
					<div class="col-md-12">
						...
						<!-- Tähän kohtaan tulee tilauksen tiedot lisättynä javalla tietokannasta -->
						...
						<table>
							<tr>
								...
								<td>
									<%
										out.println(request.getParameter("cust_nimi"));
									%>
								</td>
							</tr>
							<tr>
								...
								<td>
									<%
										out.println(request.getParameter("cust_osoite"));
									%>
								</td>
							</tr>
							...
							<td>
								<%
									out.println(request.getParameter("cust_numero"));
								%>
							</td>
							</tr>
							...
							<td>
								<%
									out.println(request.getParameter("cust_sahkoposti"));
								%>
							</td>
							</tr>
							<tr>
								...
								<td>
									<%
										out.println(request.getParameter("cust_puhelin"));
									%>
								</td>
